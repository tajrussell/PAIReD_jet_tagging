#!/bin/bash
outdir="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered/ZHcc"
outdir_test="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered/test/ZHcc"
...
mkdir -p execute/job_ZHcc_C_$3
cd execute/job_ZHcc_C_$3
...
python processFileToPAIReD.py $temp_input ${temp_output} --physicsprocess 26 -g Clustered
