#!/bin/bash
outdir="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered/XtoHH/MX-500-1000"
outdir_test="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered/test/XtoHH/MX-500-1000"
...
mkdir -p execute/job_X51C_$3
cd execute/job_X51C_$3
