#!/bin/bash
outdir="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered_1GeV/ZHcc"
outdir_test="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered_1GeV/test/ZHcc"
...
mkdir -p execute/job_ZHcc_CH_$3
cd execute/job_ZHcc_CH_$3
