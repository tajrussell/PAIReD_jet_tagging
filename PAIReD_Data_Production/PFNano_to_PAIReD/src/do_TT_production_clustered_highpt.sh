#!/bin/bash
outdir="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered_1GeV/TT"
outdir_test="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered_1GeV/test/TT"
...
mkdir -p execute/job_TTCH_$3
cd execute/job_TTCH_$3
...
python processFileToPAIReD.py $temp_input ${temp_output} --physicsprocess 66 -g Clustered_HighPT
