#!/bin/bash
outdir="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/ZHvar"
outdir_test="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/test/ZHvar"
...
mkdir -p execute/job_ZHvar_$3
cd execute/job_ZHvar_$3
...
python processFileToPAIReD.py $temp_input ${temp_output} --physicsprocess 26 -g Ellipse
