#!/bin/bash
outdir="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered/XtoHH/MX-1000-4000"
outdir_test="/home/trussel1/PAIReD_jet_tagging/PAIReD_Data_Production/PFNano_to_PAIReD/data/clustered/test/XtoHH/MX-1000-4000"
...
mkdir -p execute/job_X14C_$3
cd execute/job_X14C_$3
...
python processFileToPAIReD.py $temp_input ${temp_output} --physicsprocess 25 -g Clustered
